...
model = dict(
    ...
    train_cfg=dict(
        ...
        structure_sampler=dict(type='MaskPseudoSampler'),
        # texture assigner & sampler
        texture_assigner=dict(
            type='MSEHungarianAssigner',
            cls_cost=dict(
                type='ClassificationCost', weight=2.0),
            mse_cost=dict(
                type='MSECost', weight=5.0)),
        texture_sampler=dict(type='MaskPseudoSampler'),
        ...
        rank_sampler=dict(type='MaskPseudoSampler')),
    test_cfg=dict(
        panoptic_on=False,
...
dataset_type = 'IRSRDataset'
data_root = '/opt/data/private/SOR/data/IRSR/'
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'Images/test/rgb/',
