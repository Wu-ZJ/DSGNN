...
class SORAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        num_gt, num_query = gt_mask.shape[0], mask_pred.shape[0]
        ...
        # assigned_labels[matched_row_inds] = gt_mask[matched_col_inds]
        return AssignResult(
            num_gt, assigned_gt_inds, None, labels=assigned_labels)
