...
class Mask2FormerGNNHead8(AnchorFreeHead):
    ...
    def forward_train(self,
        ...
        texture_cls_pred_list, texture_rank_pred_list, \
        texture_mask_pred_list = self(feats, img_metas)
    ...
    def simple_test(self, feats, img_metas, **kwargs):
        ...
        """
        structure_cls_pred_list, structure_rank_pred_list, structure_mask_pred_list, \
        texture_cls_pred_list, texture_rank_pred_list, texture_mask_pred_list = self(feats, img_metas)

        rank_pred = texture_rank_pred_list[-1]
        # rank_pred = rank_results[-1]['rank_pred']
