...
class Mask2FormerGNNHeadBS(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        # build structure transformer decoder
    ...
    def loss(self, structure_cls_scores, structure_rank_scores, structure_mask_preds,
        ...
        num_dec_layer = 0
        for loss_st_cls_i, loss_st_mask_i, loss_st_dice_i, loss_st_rank_i in zip(
    ...
    def forward_train(self,
        ...
        # forward
        structure_cls_pred_list, structure_rank_pred_list, structure_mask_pred_list = self(feats, img_metas)

        # preprocess ground truth
        gt_labels, gt_masks = self.preprocess_gt(gt_labels, gt_masks,
                                                 gt_semantic_seg, img_metas)
        # print(len(gt_masks[0]), len(gt_ranks[0]), len(gt_labels[0]))
        # loss
    ...
    def simple_test(self, feats, img_metas, **kwargs):
        ...
        for cp in cls_pred:
            ...
            salient_obj[scores_per_image > 0.2] = 1
