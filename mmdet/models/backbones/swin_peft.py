...
class ShiftWindowMSA(BaseModule):
    ...
    def __init__(self,
        ...
        self.S_Adapter2 = SAdapter2(embed_dims)
...
class SwinBlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.S_Adapter = Adapter(embed_dims)
    ...
    def forward(self, x, hw_shape):
        ...
        def _inner_forward(x):
            ...
            identity = x
            x = self.norm2(x)
            x = self.ffn(x, identity=identity) + 0.5*self.S_Adapter(x)
...
class SwinTransformer_PEFT(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(SwinTransformer_PEFT, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformer_PEFT, self).train(mode)
        self._freeze_stages()
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            for n, m in self.stages.named_modules():
                if 'S_Adapter' in n:
